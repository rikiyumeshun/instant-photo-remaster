...
4. 補正モードを選びます。
   - **明るく盛る**（おすすめ）: 暗い写真を大きく明るくし、白背景を白く、肌を明るく、ほんのりピンクで血色感を足し、黒髪や目を締めてくっきり見せます。白い服や背景は少し白飛びする場合があります。
   - 自然補正: 雰囲気を残して自然に整えます。
...
`realesrgan` モードでは、ぼけ・低解像・JPEG劣化の改善を本格的な超解像で試せます。後処理は控えめで、まず超解像そのものの効果を確認する PoC です。顔復元AI（GFPGAN 等）は入れていません。顔が変わる系の処理は意図的に未実装です。
